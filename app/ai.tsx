    ...
    <SafeAreaView edges={['top', 'bottom']} style={styles.root}>
      ...
      >
        ...
        <FlatList
          ...
          onContentSizeChange={() => {
            if (keyboardOpen) listRef.current?.scrollToEnd({ animated: false });
          }}
...
const styles=StyleSheet.create({
  ...
  listView:{flex:1,minHeight:0},list:{padding:16,gap:10,paddingBottom:20},listKeyboard:{paddingBottom:8},msg:{maxWidth:'88%',padding:14,borderRadius:18},user:{alignSelf:'flex-end',backgroundColor:'#7C3AED'},ai:{alignSelf:'flex-start',backgroundColor:'#111827',borderWidth:1,borderColor:'#27324A'},msgText:{color:'#F8FAFC',lineHeight:21,textAlign:'right'},
  ...
  hints:{paddingHorizontal:14,paddingTop:8,backgroundColor:'#0B1220'},hint:{color:'#64748B',fontSize:11,textAlign:'right'},composer:{flexDirection:'row',alignItems:'flex-end',gap:10,paddingHorizontal:12,paddingTop:10,paddingBottom:10,borderTopWidth:1,borderTopColor:'#1E293B',backgroundColor:'#0B1220'},composerKeyboard:{paddingTop:8,paddingBottom:6},input:{flex:1,maxHeight:130,minHeight:48,borderRadius:17,backgroundColor:'#111827',color:'#fff',padding:12,borderWidth:1,borderColor:'#1F2937'},send:{width:48,height:48,borderRadius:16,alignItems:'center',justifyContent:'center',backgroundColor:'#7C3AED'},sendDisabled:{opacity:.4},sendText:{color:'#fff',fontSize:24,fontWeight:'900'}
});
