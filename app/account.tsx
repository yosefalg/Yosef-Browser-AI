  ...
  return <SafeAreaView style={s.root}>
    ...
    <ScrollView contentContainerStyle={s.content}>
      ...
      <View style={s.services}>
        <Pressable onPress={()=>router.push('/ai')} style={s.service}><Text style={s.serviceTitle}>RAID AI</Text><Text style={s.serviceText}>يستخدم جلسة هذا الحساب فقط</Text></Pressable>
        <Pressable onPress={()=>router.push('/vpn')} style={s.service}><Text style={s.serviceTitle}>RAID VPN</Text><Text style={s.serviceText}>الملف مرتبط بهوية الحساب</Text></Pressable>
        <Pressable onPress={()=>router.push('/tabs')} style={s.service}><Text style={s.serviceTitle}>التبويبات</Text><Text style={s.serviceText}>محفوظة محليًا على جهازك</Text></Pressable>
      </View>
