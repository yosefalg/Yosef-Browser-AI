  ...
  return (
    <SafeAreaView style={styles.root} edges={['top', 'left', 'right', 'bottom']}>
      ...
      <View style={styles.bottom}>
        ...
        <Pressable onPress={openVpn} style={[styles.vpn, vpnConnected && styles.vpnOn]} accessibilityRole="button" accessibilityLabel="فتح RAID VPN"><Text style={styles.vpnText}>VPN</Text></Pressable>
      ...
      <Modal visible={menuOpen} transparent animationType="fade" onRequestClose={() => setMenuOpen(false)}>
        <Pressable style={[styles.overlay, { paddingTop: insets.top + 62 }]} onPress={() => setMenuOpen(false)}>
          <Pressable style={styles.menuCard} onPress={() => {}}>
            ...
            <Pressable style={styles.menuItem} onPress={() => { setMenuOpen(false); router.push('/account'); }}><Text style={styles.menuItemText}>الحساب والخدمات</Text></Pressable>
            ...
            <Pressable style={styles.menuItem} onPress={openVpn}><Text style={styles.menuItemText}>RAID VPN</Text></Pressable>
      ...
      <Modal visible={Boolean(reader)} animationType="slide" onRequestClose={() => { stopSpeech(); setReader(null); }}>
        <SafeAreaView style={[styles.readerRoot, !readerDark && styles.readerLight]} edges={['top','left','right','bottom']}>
...
const styles = StyleSheet.create({
  ...
  top:{minHeight:60,flexDirection:'row',alignItems:'center',gap:6,paddingHorizontal:10,paddingVertical:8,backgroundColor:'#0A101C',borderBottomWidth:1,borderBottomColor:'#172033'},
  icon:{width:42,height:42,borderRadius:14,alignItems:'center',justifyContent:'center',backgroundColor:'#111827',borderWidth:1,borderColor:'#1F2937'},
  iconGlyph:{color:'#E5E7EB',fontSize:21,fontWeight:'800'},
  tabGlyph:{color:'#E5E7EB',fontSize:18,fontWeight:'900'},
  menuGlyph:{color:'#E5E7EB',fontSize:21,fontWeight:'900',lineHeight:24},
  omni:{flex:1,height:42,borderRadius:16,backgroundColor:'#111827',alignItems:'center',flexDirection:'row',paddingHorizontal:5,borderWidth:1,borderColor:'#1F2937',minWidth:0},
  securityButton:{width:30,height:30,borderRadius:10,alignItems:'center',justifyContent:'center'},
  ...
  overlay:{flex:1,backgroundColor:'rgba(0,0,0,.48)',alignItems:'flex-end',paddingRight:12},overlayCentered:{flex:1,backgroundColor:'rgba(0,0,0,.55)',justifyContent:'center',padding:24},
  menuCard:{width:268,borderRadius:22,padding:10,backgroundColor:'#101827',borderWidth:1,borderColor:'#27324A'},menuHeader:{paddingHorizontal:12,paddingVertical:9,borderBottomWidth:1,borderBottomColor:'#27324A',marginBottom:4},menuTitle:{color:'#F8FAFC',fontSize:15,fontWeight:'900',textAlign:'right'},menuHost:{color:'#64748B',fontSize:11,marginTop:3,textAlign:'right'},menuItem:{minHeight:44,borderRadius:13,justifyContent:'center',paddingHorizontal:12},menuItemText:{color:'#F8FAFC',fontSize:14,fontWeight:'700',textAlign:'right'},menuDivider:{height:1,backgroundColor:'#27324A',marginVertical:5},
