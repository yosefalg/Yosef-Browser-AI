...
export default function ContactScreen(){
  ...
  return <SafeAreaView style={s.root}>
    ...
    <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
      ...
      <Pressable onPress={()=>open(instagram)} style={({pressed})=>[s.card,pressed&&s.pressed]}><View style={s.icon}><Text style={s.iconText}>IG</Text></View><View style={s.info}><Text style={s.name}>Instagram</Text><Text style={s.value}>@k5w._</Text></View><Text style={s.chev}>‹</Text></Pressable>
