...
const styles = StyleSheet.create({
  ...
  pageShield:{width:'100%',flexDirection:'row',alignItems:'center',gap:10,paddingHorizontal:12,paddingVertical:11,borderRadius:16,backgroundColor:'#233831',borderWidth:1,borderColor:'#365D50'},
