...
export default function SettingsScreen(){
  ...
  return <SafeAreaView edges={['top','bottom','left','right']} style={s.root}>
    ...
    <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
      ...
      <Row title="مزود VPN بديل" hint="ربط Proton أو أي إعداد WireGuard قياسي" onPress={()=>router.push('/vpn-provider')}/>
...
const s=StyleSheet.create({
  ...
  head:{minHeight:64,flexDirection:'row',alignItems:'center',justifyContent:'space-between',paddingHorizontal:14,paddingVertical:6,borderBottomWidth:1,borderBottomColor:'#D8D2CB',backgroundColor:'rgba(246,243,238,.98)'},
